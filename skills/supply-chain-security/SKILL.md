...
description: 供应链安全：SBOM / SCA、CI-CD 管道安全、依赖扫描、容器安全、构建完整性、漏洞可达性验证。Supply chain security — SBOM/SCA, CI/CD pipeline, dependency and container scanning, build integrity.
license: MIT
---
