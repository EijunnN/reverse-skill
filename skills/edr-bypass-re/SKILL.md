---
name: edr-bypass-re
description: 授权红队场景下逆向 EDR/AV 的检测机制（hook 表、ETW、AMSI），研究直接系统调用、硬件断点、调用栈欺骗等对抗技术。Reverse EDR/AV detection mechanisms in authorized red-team research — hook tables, ETW, AMSI, direct syscalls.
license: MIT
---
...
| 内网横向 / AD 攻击 | `../pentest-tools/references/network-attack-defense.md` |
...
- `../pentest-tools/references/network-attack-defense.md` — 内网横向时如何与本 skill 联动
